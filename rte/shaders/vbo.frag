...
//	txY.r = 0.5;
	...
	gl_FragData[0] = vec4(txCbCr.r * chroma_scale,txCbCr.a * chroma_scale,0.0,1.0); //vec4 (0.0 , 1.0 , 0.0 , 1.0) ;
...
//	float a = (gl_FragData[1].b+gl_FragData[1].g+gl_FragData[1].r) * 0.1;
